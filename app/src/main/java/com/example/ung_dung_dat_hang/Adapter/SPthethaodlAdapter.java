...
public class SPthethaodlAdapter extends RecyclerView.Adapter<SPthethaodlAdapter.SanPhamViewHolder>{
    private List<SanPham> sanPhamList;

    public SPthethaodlAdapter(List<SanPham> sanPhamList) {
        this.sanPhamList = sanPhamList;
    }

    @NonNull
    @Override
    public SPthethaodlAdapter.SanPhamViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_sanpham, parent, false);
        return new SPthethaodlAdapter.SanPhamViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SPthethaodlAdapter.SanPhamViewHolder holder, int position) {
