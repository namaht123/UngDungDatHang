...
public class SPnhavadoisongAdapter extends RecyclerView.Adapter<SPMeBeAdapter.SanPhamViewHolder> {

    private List<SanPham> sanPhamList;

    public SPnhavadoisongAdapter(List<SanPham> sanPhamList) {
        this.sanPhamList = sanPhamList;
    }

    @NonNull
    @Override
    public SPMeBeAdapter.SanPhamViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_sanpham, parent, false);
        return new SPMeBeAdapter.SanPhamViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SPMeBeAdapter.SanPhamViewHolder holder, int position) {
